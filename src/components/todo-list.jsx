...
export default function TodoList() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start p-6">
      <div className="w-full max-w-auto bg-white p-6 rounded-xl">
        <div className="flex flex-row my-4 gap-4 justify-between">
          ...
          <button
            ...
            className="bg-red-700 text-white text-semibold flex justify-center items-center text-[20px] rounded-md px-8">Add</button>
        </div>
          ...
          {list.map((item, ind) => (
            ...
            >
              ...
              <button
                ...
                className="absolute bg-sky-700 w-6 h-6 rounded-full border border-sky-900 cursor-pointer text-[12px] font-bold -top-2 -right-2 text-white hover:scale-125">X</button>
            </div>
          ))}
        </div>
      </div>
